...
CGameObject* CObject_Manager::Find_UI_Object(_uint iLevelIndex, const _wstring& strLayerTag, const _wstring& strUIObjectName)
{
	return nullptr;
}

list<class CGameObject*> CObject_Manager::Find_Layer_Object_All(_uint iLevelIndex, const _wstring& strLayerTag)
{
	return Find_Layer(iLevelIndex, strLayerTag)->Get_GameObject_List();
}
